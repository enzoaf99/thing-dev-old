                        ...
                        <div className="col-6 p-5">
                            <div className='tarjeta'>
                                <div>
                                    ...
                                    <p className="text-black fs-6">Contarás con asesoramiento de nuestro equipo para que tu página se adapte a las necesidades y objetivo de tu proyecto/negocio.</p>
                                    <ModalService desc={1} />
                                </div>
                            </div>
                        </div>
