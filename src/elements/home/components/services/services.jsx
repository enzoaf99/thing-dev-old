        ...
        <section className="service" id="service">
            ...
            <Fade duration={2000}>
                <div className="card-list">
                    <div className="card">
                        <img className="card-icon" src="./src/assets/web0.png" alt="" />
                    ...
                    <div className="card">
                        <img className="card-icon" src="./src/assets/database.png" alt="" />
                    ...
                    <div className="card">
                        <img className="card-icon" src="./src/assets/fix.png" alt="" />
            ...
            <Fade duration={2000}>
                <div className="img-list">
                    <img className="img-service1" src={ImagenServicio1} alt="" />
                    <img className="img-service2" src={ImagenServicio2} alt="" />
                    <img className="img-service3" src={ImagenServicio3} alt="" />
                </div>
            </Fade>
        </section>
    )
